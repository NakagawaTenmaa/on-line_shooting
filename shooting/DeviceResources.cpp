...
DirectX::CommonStates* DX::DeviceResources::m_commonStates = nullptr;
...
/// 実体削除
/// </summary>
void DX::DeviceResources::LostInstance()
{
	if (m_instance != nullptr)
	{
		delete m_instance;
...
void DX::DeviceResources::CreateDeviceResources()
{
	...
	if (m_commonStates == nullptr)
	{
		m_commonStates = new DirectX::CommonStates(GetD3DDevice());
	}
}
